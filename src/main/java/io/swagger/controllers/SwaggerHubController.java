...
import io.swagger.model.SwaggerDto;
...
public class SwaggerHubController  {
  ...
  /*
    public ResponseContext swaggerHubGET(RequestContext request ) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext swaggerHubPOST(RequestContext request ) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
